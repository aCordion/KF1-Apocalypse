...
//=============================================================================
class RPGBallisticEmitter extends Emitter
	placeable;
...
simulated event PostBeginPlay()
{
	...
	super.PostBeginPlay();
	if (class'RPGBallisticMod'.default.EffectsDetailMode < 2)
	{
		for (i=0;i<Emitters.length;i++)
			if (Emitters[i].DetailMode > class'RPGBallisticMod'.default.EffectsDetailMode)
