class MolotovFTProjEX extends FlameTendril;

var() MolotovFTFuelFlameEX FF;
var() bool bHasLanded;
...
simulated function Explode(vector HitLocation,vector HitNormal)
{
	...
	if ( KFHumanPawn(Instigator) != none )
	{
		...
		{
			Spawn(Class'MolotovFTFuelFlameEX',self,,Location);
		}
	}
...
simulated function Landed( vector HitNormal )
{
	...
	if ( KFHumanPawn(Instigator) != none )
	{
		if ( EffectIsRelevant(Location,false) )
		{
			FF = Spawn(Class'MolotovFTFuelFlameEX',self);
