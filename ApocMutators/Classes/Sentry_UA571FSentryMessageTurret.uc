class Sentry_UA571FSentryMessageTurret extends LocalMessage;
...
defaultproperties
{
     Message(0)="Can't deploy UA-571F Sentry here"
     Message(1)="UA-571F Sentry deployed"
     Message(2)="UA-571F Sentry destroyed"
     bIsUnique=True
     bFadeMessage=True
     Lifetime=8
