...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    if (Role == ROLE_Authority)
    {
     ...
     //{
        ...
        {
            Spawn(Class'ApocMutators.WTFEquipAFS12ExplosiveRoundEmitter', self, , Location);
        }
...
simulated function ProcessTouch(Actor Other, vector HitLocation)
{
    ...
    {
        Other.Velocity.X = Self.Velocity.X * 0.07;
        Other.Velocity.Y = Self.Velocity.Y * 0.07;
        Other.Velocity.Z = Self.Velocity.Z * 0.07;
