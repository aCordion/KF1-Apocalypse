class FreezerIceDart extends ShotgunBullet;
...
simulated function PostBeginPlay()
{
    ...
    if ( Level.NetMode != NM_DedicatedServer )
    {
        ...
        {
            Trail = Spawn(class'FreezerIceDartTracer',self);
            Trail.Lifespan = Lifespan;
            if ( Level.DetailMode >= DM_SuperHigh ) {
                TrailEffect = Spawn(class'FreezerIceDartTrail',self);
...
defaultproperties
{
     ...
     ImpactEffect=Class'FreezerIceDartHitEffect'
     Speed=5000.000000
     MaxSpeed=7000.000000
     Damage=45.000000
     MyDamageType=Class'FreezerDartDamType'
