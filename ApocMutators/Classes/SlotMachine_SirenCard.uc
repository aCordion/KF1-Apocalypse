class SlotMachine_SirenCard extends SlotMachine_MonsterSpawnCard;
...
defaultproperties
{
	 SpawnMessage=Class'ApocMutators.SlotMachine_SirenMessage'
	 MonsterClass=Class'KFChar.ZombieSiren'
	 NumMonsters=4
	 CardMaterial=Texture'KillingFloorHUD.Achievements.Achievement_22'
}
