class SlotMachine_FleshPoundCard extends SlotMachine_MonsterSpawnCard;
...
defaultproperties
{
	 SpawnMessage=Class'ApocMutators.SlotMachine_FleshPoundMessage'
	 MonsterClass=Class'ApocZEDPack.MutantZombieFleshPound'
	 NumMonsters=2
	 Desireability=0.500000
	 CardMaterial=Texture'KillingFloorHUD.Achievements.Achievement_31'
}
