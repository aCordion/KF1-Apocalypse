class Sentry_UA571HSentryMessageTurret extends LocalMessage;
...
defaultproperties
{
     Message(0)="Can't deploy UA-571H Sentry here"
     Message(1)="UA-571H Sentry deployed"
     Message(2)="UA-571H Sentry destroyed"
     bIsUnique=True
     bFadeMessage=True
     Lifetime=8
