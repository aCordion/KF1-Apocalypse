...
// Modified by Marco
//====================================================================
class MapVote_MVMultiColumnList extends MapVoteMultiColumnList;
...
function DrawItem(Canvas Canvas, int i, float X, float Y, float W, float H, bool bSelected, bool bPending)
{
	...
	DrawStyle.DrawText( Canvas, MState, CellLeft, Y, CellWidth, H, TXTA_Left,
		MapVote_KFVotingReplicationInfo(VRI).RepArray[MapVoteData[SortData[i].SortItem]], FontScale);
}
//------------------------------------------------------------------------------------------------
function string GetSortString(int i)
{
	...
	ColumnData[3] = MapVote_KFVotingReplicationInfo(VRI).RepArray[MapVoteData[i]];
