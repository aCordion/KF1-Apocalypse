Class MapVote_MVLevelCleanup extends Interaction;
...
static final function AddVotingReplacement(PlayerController PC)
{
    ...
    C.Initialize();
    GUIController(PC.Player.GUIController).MapVotingMenu = string(Class'MapVote_KFMapVotingPageX');
}
