...
class Weapon_Dual44MagnumLaser extends Weapon_Dual44Magnum
    Config(ApocMutators);
...
simulated function ToggleLaser()
{
    ...
    else LaserType = class'ApocMutators.Weapon_M14EBRBattleRifle'.default.LASER_Orange;
...
defaultproperties
{
     ...
     InventoryGroup=4
     PickupClass=Class'ApocMutators.Weapon_Dual44MagnumLaserPickup'
