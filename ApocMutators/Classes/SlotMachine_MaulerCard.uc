class SlotMachine_MaulerCard extends SlotMachine_MonsterSpawnCard;
...
defaultproperties
{
     SpawnMessage=Class'ApocMutators.SlotMachine_MaulerMessage'
     MonsterClass=Class'ApocMutators.WTFZombiesMauler'
     NumMonsters=10
     CardMaterial=Texture'KillingFloorHUD.Achievements.Achievement_25'
}
