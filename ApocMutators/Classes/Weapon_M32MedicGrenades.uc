...
// 03/02/2013
//=============================================================================
class Weapon_M32MedicGrenades extends Nade;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
        Spawn(Class'ApocMutators.Weapon_M32GrenadeHealing',,, HitLocation, rotator(vect(0,0,1)));
...
defaultproperties
{
     ...
     MyDamageType=Class'ApocMutators.Weapon_DamTypeM32MedicGrenade'
     ExplosionDecal=Class'ApocMutators.Weapon_M32MedicGrenadeDecal'
