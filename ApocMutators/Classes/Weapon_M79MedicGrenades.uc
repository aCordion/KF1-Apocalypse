...
// 03/02/2013
//=============================================================================
class Weapon_M79MedicGrenades extends Nade;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
        Spawn(Class'ApocMutators.Weapon_M79GrenadeHealing',,, HitLocation, rotator(vect(0,0,1)));
...
defaultproperties
{
     ...
     MyDamageType=class'ApocMutators.Weapon_DamTypeM79MedicGrenade'
     ExplosionDecal=Class'ApocMutators.Weapon_M79MedicGrenadeDecal'
