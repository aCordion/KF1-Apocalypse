...
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\11_FROWN.pcx" NAME="I_Frown" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\12_INDIFFE.pcx" NAME="I_Indiffe" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\13_OHWELL.pcx" NAME="I_Ohwell" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\16_BIGGRIN.pcx" NAME="I_BigGrin" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\17_TONGUE1.pcx" NAME="I_Tongue" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\17_TONGUE2.pcx" NAME="I_TongueB" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\18_REDFACE.pcx" NAME="I_RedFace" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\19_GREENLI1.pcx" NAME="I_GreenLick" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\19_GREENLI2.pcx" NAME="I_GreenLickB" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\Ban.pcx" NAME="I_Ban" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\COOL.pcx" NAME="I_Cool" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\HM.pcx" NAME="I_Hmm" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\MAD.pcx" NAME="I_Mad" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\SCREAM6.pcx" NAME="I_Scream" GROUP="Emo" MIPS=0 MASKED=1
#exec TEXTURE IMPORT FILE="Assets\ServerPerks\SPAM.pcx" NAME="I_Spam" GROUP="Emo" MIPS=0 MASKED=1
...
function DrawPlayerInfo(Canvas C, Pawn P, float ScreenLocX, float ScreenLocY)
{
    ...
    //kyan: add
    Lv = "Lvl" @ TempLevel;
    C.Font = LoadSmallFontStatic(7);
    C.SetDrawColor(255, 255, 255, BeaconAlpha);
    C.SetPos((ScreenLocX - 47), (ScreenLocY - 60));
    C.DrawTextClipped(Lv);
...
simulated function DrawHudPassA (Canvas C)
{
	...
	if ( SV!=None )
	{
        ...
        if (KFHPawn != none)
        {
            ...
            C.SetPos((TempX + 12.f),(TempY + 65.f));
            C.DrawTextClipped("Lvl" @ TempLevel @ ", HP" @ int(KFHPawn.HealthMax));
        }
    }
