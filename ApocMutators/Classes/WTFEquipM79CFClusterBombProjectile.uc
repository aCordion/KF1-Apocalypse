...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
        Spawn(Class'ApocMutators.WTFEquipM79CFExplosionEmitter', self, , HitLocation + HitNormal * 20, rotator(HitNormal));
    }
...
defaultproperties
{
     ProjectileClass=Class'ApocMutators.WTFEquipM79CFClusterBomblet'
     NumProjectiles=4
     Speed=1250.000000
