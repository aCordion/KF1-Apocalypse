...
class Weapon_M99SniperRifle extends M99SniperRifle;
...
static function PreloadAssets(Inventory Inv, optional bool bSkipRefCount)
{
	...
	if ( Weapon_M99SniperRifle(Inv) != none )
	{
		Weapon_M99SniperRifle(Inv).ZoomMat = default.ZoomMat;
		Weapon_M99SniperRifle(Inv).ScriptedTextureFallback = default.ScriptedTextureFallback;
	}
}
...
defaultproperties
{
    ...
    Weight=13.000000
    ReloadRate=4.376000
    FireModeClass(0)=Class'ApocMutators.Weapon_M99Fire'
    ...
    InventoryGroup=4
    GroupOffset=14
    PickupClass=Class'ApocMutators.Weapon_M99Pickup'
    PlayerViewOffset=(X=15.000000,Y=15.000000,Z=-2.500000)
    BobDamping=4.500000
    AttachmentClass=Class'ApocMutators.Weapon_M99Attachment'
