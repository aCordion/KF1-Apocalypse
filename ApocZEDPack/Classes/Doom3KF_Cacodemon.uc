class Doom3KF_Cacodemon extends Doom3KF_DoomMonster;
...
var Doom3KF_CacodemonMouthTorch Vents[2];
var Doom3KF_CacodemonMouthFlare MouthFlare;
...
simulated function PostBeginPlay()
{
	...
	{
		Vents[0] = Spawn(class'Doom3KF_CacodemonMouthTorch');
		AttachToBone(Vents[0], 'LVent');
		Vents[1] = Spawn(class'Doom3KF_CacodemonMouthTorch');
...
simulated function FireProjectile()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
	{
		MouthFlare = Spawn(class'Doom3KF_CacodemonMouthFlare');
...
defaultproperties
{
     ...
     BurnClass=Class'Doom3KF_CacodemonBurnTex'
     FadeClass=Class'Doom3KF_CacodemonMaterialSequence'
     RangedProjectile=Class'Doom3KF_CacodemonProjectile'
     DoomTeleportFXClass=Class'Doom3KF_DemonSpawnB'
     HasHitAnims=True
     aimerror=200
     ...
     Health=500
     MenuName="Cacodemon"
     ControllerClass=Class'Doom3KF_CacodemonAI'
