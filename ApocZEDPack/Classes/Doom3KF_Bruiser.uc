class Doom3KF_Bruiser extends Doom3KF_DoomMonster;
...
simulated function LFireGlow()
{
	...
	Spawn(class'Doom3KF_RevenantSmokePuffs', self, , BoneLocation.Origin);
}
...
defaultproperties
{
     ...
     FadeScreenClass=Class'Doom3KF_BruiserScreenMaterialSequence'
     FadeMouthClass=Class'Doom3KF_BruiserMouthMaterialSequence'
     DeathAnims(0)="DeathF"
     DeathAnims(1)="DeathB"
     DeathAnims(2)="DeathF"
     DeathAnims(3)="DeathB"
     ...
     BurnClass=Class'Doom3KF_BruiserBurnTex'
     FadeClass=Class'Doom3KF_BruiserMaterialSequence'
     MeleeKnockBack=26000.000000
     RangedProjectile=Class'Doom3KF_BruiserProjectile'
     HasHitAnims=True
     BigMonster=True
     aimerror=100
