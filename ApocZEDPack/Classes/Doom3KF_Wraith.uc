class Doom3KF_Wraith extends Doom3KF_DoomMonster;
...
simulated function SpawnTeleEffects(vector OldLoc, vector NewLoc)
{
	...
	xBeam = Spawn(class'Doom3KF_PortalBeam', , , OldLoc);
	xBeam.mSpawnVecA = NewLoc;
	Spawn(class'Doom3KF_HellPortalFlare', , , OldLoc).PlaySound(TeleportOut);
	Spawn(class'Doom3KF_HellPortal', , , NewLoc).PlaySound(TeleportIn);
}
...
defaultproperties
{
     ...
     BurnClass=Class'Doom3KF_WraithBurnTex'
     FadeClass=Class'Doom3KF_WraithMaterialSequence'
     ...
     MenuName="Wraith"
     ControllerClass=Class'Doom3KF_WraithController'
     MovementAnims(0)="Run"
     MovementAnims(1)="Run"
     MovementAnims(2)="Run"
     MovementAnims(3)="Run"
