class Doom3KF_ArchvileProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_ArchvileFireWallEffect Trail;
var vector OldPos;
...
simulated function PostBeginPlay()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
		Trail = Spawn(class'Doom3KF_ArchvileFireWallEffect', self);
...
simulated function HurtRadius(float DamageAmount, float DamageRadius, class<DamageType> DamageType, float Momentum, vector HitLocation)
{
	...
	{
		if ((Victims != self) && Doom3KF_Archvile(Victims)==None && (Victims.Role == ROLE_Authority) && !Victims.IsA('FluidSurfaceInfo') && ExtendedZCollision(Victims)==None)
		{
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeArchvileFireWall'
     LightType=LT_Steady
