class Doom3KF_MaledictMeteorBigProj extends Doom3KF_DoomProjectile;
...
simulated function PostBeginPlay()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
	{
		...
		Trail = Spawn(class'Doom3KF_MaledictBigMeteorTrail', self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_MaledictBigProjExplosion', , , Location);
	Destroy();
}
