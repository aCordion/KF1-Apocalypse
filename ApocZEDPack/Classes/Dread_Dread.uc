...
class Dread_Dread extends Dread_DreadBase
	Config(ApocZEDPack);
...
function SpawnTwoShots()
{
	...
	if ( !SavedFireProperties.bInitialized )
	{
		...
		SavedFireProperties.ProjectileClass = Class'Dread_LAWProj';
	...
	Spawn(Class'Dread_LAWProj',,,FireStart,FireRotation);
...
simulated function Tick(float deltatime)
{
        ...
        HitDamageType != class'DamTypeBleedOut' )
    {
        if ( !class'GameInfo'.static.UseLowGore() )
        {
	        ...
	        GibKFIncendiaryExplosion = Spawn(class 'Dread_KFIncendiaryExplosion',self,, KFIncendiaryExplosionLoc );
...
function BileBomb()
{
	BloatJet = spawn(class'Dread_BileJet', self,,Location,Rotator(-PhysicsVolume.Gravity));
}
