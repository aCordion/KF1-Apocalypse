class Doom3KF_LostSoul extends Doom3KF_DoomMonster;

var Doom3KF_Maledict MSummoner;
...
simulated function PostBeginPlay()
{
	...
	{
		Rot.Roll = -16384;
		LostTrail = Spawn(class'Doom3KF_LostSoulTrailEffect', Self);
...
simulated function PlayDirectionalDeath(Vector HitLoc)
{
	...
	if (Level.NetMode != NM_DedicatedServer)
	{
		Spawn(class'Doom3KF_LostSoulExplosion');
		Spawn(class'Doom3KF_LostSoulExplodeDust');
	}
	bHidden = true;
	if (LostTrail != None)
		LostTrail.Kill();
...
defaultproperties
{
     ...
     Health=140
     MenuName="Lost Soul"
     ControllerClass=Class'Doom3KF_LostSoulAI'
