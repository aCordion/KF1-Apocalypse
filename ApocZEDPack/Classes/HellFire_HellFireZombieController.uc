//=============================================================================
// HellFire_HellFireZombieController
//=============================================================================
...
//=============================================================================
class HellFire_HellFireZombieController extends KFMonsterController;
...
function bool FireWeaponAt(Actor A)
{
	...
	if( (VSize(A.Location - Pawn.Location) >= HellFire_ZombieHellFire(Pawn).MeleeRange + Pawn.CollisionRadius + Target.CollisionRadius) &&
        HellFire_ZombieHellFire(Pawn).NextFireProjectileTime - Level.TimeSeconds > 0 )
    {
        return false;
    }
