class Doom3KF_HunterHellTime extends Doom3KF_DoomMonster;

var transient float NextRangedTime;
var bool bTeleportNow;
var Doom3KF_HunterHellTimeTrailEffect Trails[8];
var Doom3KF_ImpHandTrail FireTrail;
...
simulated function PostBeginPlay()
{
    ...
    if (Level.NetMode != NM_DedicatedServer)
    {
        ...
        Trails[0] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[0], 'chunk1_joint');
        Trails[1] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[1], 'chunk2_joint');
        Trails[2] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[2], 'chunk3_joint');
        Trails[3] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[3], 'chunk4_joint');
        Trails[4] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[4], 'chunk5_joint');
        Trails[5] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[5], 'chunk6_joint');
        Trails[6] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
        AttachToBone(Trails[6], 'chunk7_joint');
        Trails[7] = Spawn(class'Doom3KF_HunterHellTimeTrailEffect', self);
...
simulated function SpawnTeleEffects(vector OldLoc, vector NewLoc)
{
    ...
    local Doom3KF_HunterHellTimePortal Portal;

    xBeam = Spawn(class'Doom3KF_HunterHellTimeBeam', , , OldLoc);
    xBeam.mSpawnVecA = NewLoc;
    BoneLocation = GetBoneCoords('Ruparm_orbit');
    xBeamSmall[0] = Spawn(class'Doom3KF_HunterHellTimeThinBeam', , , OldLoc);
    xBeamSmall[0].mSpawnVecA = BoneLocation.Origin;
    BoneLocation = GetBoneCoords('Luparm_orbit');
    xBeamSmall[1] = Spawn(class'Doom3KF_HunterHellTimeThinBeam', , , OldLoc);
    xBeamSmall[1].mSpawnVecA = BoneLocation.Origin;
    Spawn(class'Doom3KF_HunterHellTimeFlare', self, , OldLoc, );
    Portal = Spawn(class'Doom3KF_HunterHellTimePortal', , , NewLoc, Rotation);
    Portal.SetBase(self);
...
simulated function SpawnLProj()
{
    if (Level.NetMode != NM_DedicatedServer)
    {
        FireTrail = Spawn(class'Doom3KF_ImpHandTrail');
...
defaultproperties
{
     ...
     RangedProjectile=Class'Doom3KF_HunterHellTimeProjectile'
     ...
     HealthMax=7500.00000 //4500.000000 kyan
     Health=7500 //4500 kyan
     ...
     ControllerClass=Class'Doom3KF_HunterHellTimeAI'
