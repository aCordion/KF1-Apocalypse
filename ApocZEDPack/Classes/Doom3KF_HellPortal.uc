class Doom3KF_HellPortal extends Doom3KF_DoomEmitter;

simulated function PostBeginPlay()
{
	Spawn(class'Doom3KF_WraithTeleportScorch', , , Location+vect(0, 0, 10));
	Super.PostBeginPlay();
	SetTimer(2.00, false);
}
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'Doom3KF_HellPortal.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'Doom3KF_HellPortal.SpriteEmitter1'
