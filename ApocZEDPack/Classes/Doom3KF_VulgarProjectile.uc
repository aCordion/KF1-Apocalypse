class Doom3KF_VulgarProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_VulgarProjTrail Trail;
...
simulated function PostBeginPlay()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
		Trail = Spawn(class'Doom3KF_VulgarProjTrail', self);
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_VulgarProjExplosion', , , Location);
	Destroy();
}
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeVulgarProj'
     LightType=LT_Steady
