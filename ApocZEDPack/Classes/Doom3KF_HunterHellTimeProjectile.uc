class Doom3KF_HunterHellTimeProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_HunterProjTrail Trail;
...
simulated function PostBeginPlay()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
		Trail = Spawn(class'Doom3KF_HunterProjTrail', self);
}

simulated function Explode(vector HitLocation, vector HitNormal)
{
	HurtRadius(Damage, DamageRadius, MyDamageType, MomentumTransfer, HitLocation);
	HurtRadius(Damage, DamageRadius, Class'Doom3KF_DamTypeBruiserProj', MomentumTransfer, HitLocation);
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeHunterProj'
