class Doom3KF_BruiserProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_BruiserProjTrail Trail;
...
simulated function PostBeginPlay()
{
	...
	if (Level.NetMode != NM_DedicatedServer)
		Trail = Spawn(class'Doom3KF_BruiserProjTrail', self);
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeBruiserProj'
