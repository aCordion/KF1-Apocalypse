Class Doom3KF_WraithController extends Doom3KF_Doom3Controller;
...
SpecialNavig:
	...
	if (TotalTeleTime>Level.TimeSeconds && NavigationPoint(MoveTarget) != None && VSize(Enemy.Location-Pawn.Location)>Doom3KF_Wraith(Pawn).TeleportRadius)
	{
		Doom3KF_Wraith(Pawn).TeleportTo(MoveTarget.Location);
		Sleep(0.4f);
	}
