class Doom3KF_Vulgar extends Doom3KF_DoomMonster;
...
var Doom3KF_VulgarHandTrail FireTrail;
...
simulated function OutGoingSmallFireBall()
{
	...
	{
		FireTrail = Spawn(class'Doom3KF_VulgarHandTrail', self);
...
defaultproperties
{
     ...
     FadeTailClass=Class'Doom3KF_VulgarTailMaterialSequence'
     DeathAnims(0)="DeathF"
     DeathAnims(1)="DeathB"
     DeathAnims(2)="DeathF"
     DeathAnims(3)="DeathB"
     ...
     RangedProjectile=Class'Doom3KF_VulgarProjectile'
     DoomTeleportFXClass=Class'Doom3KF_VulgarSpawn'
