class Doom3KF_ImpProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_ImpFireBallTrail Trail;
var Doom3KF_ImpProjSmokeTrail SmokeTrail;
...
simulated function PostBeginPlay()
{
	...
	{
		Trail = Spawn(class'Doom3KF_ImpFireBallTrail', self);
		SmokeTrail = Spawn(class'Doom3KF_ImpProjSmokeTrail', self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_ImpFireBallExplosion', , , Location);
	ShakeView(200.f, 1.f);
	Destroy();
}
