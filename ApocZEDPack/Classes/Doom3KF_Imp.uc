class Doom3KF_Imp extends Doom3KF_DoomMonster;
...
defaultproperties
{
     ...
     BurnClass=Class'Doom3KF_ImpBurnTex'
     FadeClass=Class'Doom3KF_ImpMaterialSequence'
     RangedProjectile=Class'Doom3KF_ImpProjectile'
     HasHitAnims=True
     BigMonster=True
     aimerror=5
     ...
     ColOffset=(X=8.000000,Z=48.000000)
     ColRadius=30.000000
     ColHeight=30.000000
