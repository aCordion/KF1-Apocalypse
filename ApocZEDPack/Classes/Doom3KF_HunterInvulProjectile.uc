class Doom3KF_HunterInvulProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_HunterInvulProjTrail Trail;
...
simulated function PostBeginPlay()
{
	...
	{
		Trail = Spawn(class'Doom3KF_HunterInvulProjTrail', self);
		Trail.SetBase(self);
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_HunterInvulProjExplosion', , , HitLocation+HitNormal);
	ShakeView(180.f, 1.f);
	Destroy();
}
