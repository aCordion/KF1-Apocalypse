class Doom3KF_ArchvileFlameAttackProjectile extends Doom3KF_DoomProjectile;
...
simulated function PostBeginPlay()
{
	...
	{
		Spawn(class'Doom3KF_ArchvileFlameAttackEffect');
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeArchvileFlames'
     LightType=LT_Steady
