class Doom3KF_HellKnightProjectile extends Doom3KF_DoomProjectile;

var Doom3KF_HellKnightTrail Trail;
var Doom3KF_HellKnightProjSmokeTrail SmokeTrail;
...
simulated function PostBeginPlay()
{
	...
	{
		Trail = Spawn(class'Doom3KF_HellKnightTrail', self);
		SmokeTrail = Spawn(class'Doom3KF_HellKnightProjSmokeTrail', self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_HellKnightProjExplosion', , , Location, rotator(HitNormal));
	ShakeView(300.f, 2.f);
	Destroy();
}
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeHellKnightProj'
     LightType=LT_Steady
