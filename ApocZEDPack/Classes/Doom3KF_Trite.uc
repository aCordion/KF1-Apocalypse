class Doom3KF_Trite extends Doom3KF_Tick;
...
simulated function Implode()
{
	...
	{
		Spawn(class'Doom3KF_TriteExplode', , , GetBoneCoords('Head').Origin);
		LifeSpan = 0.25f;
	}
}
...
{
	Super(Doom3KF_DoomMonster).SpawnSparksFX();
}

simulated function ZombieCrispUp()
{
	Super(Doom3KF_DoomMonster).ZombieCrispUp();
}
...
defaultproperties
{
     ...
     BurnDust=Class'Doom3KF_DoomDeResDustSmall'
     MeleeDamage=14
