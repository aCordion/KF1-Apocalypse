class Doom3KF_MaledictFireWallProj extends Doom3KF_DoomProjectile;

var Doom3KF_MaledictFireWallTrail Trail;
...
simulated function PostBeginPlay()
{
	if (Level.NetMode != NM_DedicatedServer)
	{
		...
		Trail = Spawn(class'Doom3KF_MaledictFireWallTrail', self);
	}
...
simulated function HurtRadius(float DamageAmount, float DamageRadius, class<DamageType> DamageType, float Momentum, vector HitLocation)
{
	...
	{
		if ((Victims != self) && Doom3KF_Maledict(Victims)==None && (Victims.Role == ROLE_Authority) && !Victims.IsA('FluidSurfaceInfo') && ExtendedZCollision(Victims)==None)
		{
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeMaledict'
     LightType=LT_Steady
