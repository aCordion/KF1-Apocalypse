...
class Dread_LAWProj extends ROBallisticProjectile;
...
var Dread_PanzerfaustTrail SmokeTrail;
var vector Dir;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
		Spawn(class'Dread_LawExplosion',,,HitLocation + HitNormal*20,rotator(HitNormal));
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'Dread_PanzerfaustTrail',self);
