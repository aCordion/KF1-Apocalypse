class Doom3KF_Commando extends Doom3KF_DoomMonster;
...
defaultproperties
{
     ...
     FadeTentacleClass=Class'Doom3KF_CommandoTentacleMaterialSequence'
     DeathAnims(0)="DeathF"
     DeathAnims(1)="DeathB"
     DeathAnims(2)="DeathF"
     DeathAnims(3)="DeathB"
     ...
     FadeClass=Class'Doom3KF_CommandoMaterialSequence'
