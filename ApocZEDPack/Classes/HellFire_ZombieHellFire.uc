...
//=============================================================================
class HellFire_ZombieHellFire extends HellFire_ZombieHellFireBase
	Config(ApocZEDPack);
...
function SpawnTwoShots()
{
	...
	if ( !SavedFireProperties.bInitialized )
	{
		...
		SavedFireProperties.ProjectileClass = Class'HellFire_HellFireFireProjectile';
    ...
    Spawn(Class'HellFire_HellFireFireProjectile',,,FireStart,FireRotation);
...
defaultproperties
{
     ...
     ControllerClass=Class'HellFire_HellFireZombieController'
}
