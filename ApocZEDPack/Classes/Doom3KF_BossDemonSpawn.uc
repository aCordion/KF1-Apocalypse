class Doom3KF_BossDemonSpawn extends Doom3KF_DemonSpawnBase;
...
simulated function PostBeginPlay()
{
    if (Level.NetMode != NM_DedicatedServer)
        Spawn(class'Doom3KF_DoomSymbolProjector', , , Location + vect(0, 0, 10));
...
function Timer()
{
    ...
    if (Class<Doom3KF_DoomMonster>(DM) != None)
    {
        Class<Doom3KF_DoomMonster>(DM).default.bIsBossSpawn = true;
        M = Spawn(DM);
        Class<Doom3KF_DoomMonster>(DM).Default.bIsBossSpawn = false;
    }
    else
    {
        M = Spawn(DM);
    ...
    KFGameType(Level.Game).TotalMaxMonsters *= class'Doom3KFMut'.Default.BossWaveReduction; // Reduce monsters in wave because of boss.

    //kyan: removed
    //M.Health += (Class<Doom3KF_DoomMonster>(DM).Default.Health * class'Doom3KFMut'.Default.BossPerPlayerHP * Max(Level.Game.NumPlayers-1, 0));
    Health = Class<Doom3KF_DoomMonster>(DM).default.Health;
    M.Health = Health + (Health * class'Doom3KFMut'.Default.BossPerPlayerHP * Max(Level.Game.NumPlayers-1, 0));
    M.HealthMax = M.Health;

    if (Doom3KF_DoomMonster(M) != None)
        Doom3KF_DoomMonster(M).NotifyTeleport();
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter1'
     ...
     End Object
     Emitters(2)=BeamEmitter'Doom3KF_BossDemonSpawn.BeamEmitter0'
     ...
     End Object
     Emitters(3)=BeamEmitter'Doom3KF_BossDemonSpawn.BeamEmitter1'
     ...
     End Object
     Emitters(4)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter2'
     ...
     End Object
     Emitters(5)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter3'
     ...
     End Object
     Emitters(6)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         InitialDelayRange=(Min=2.800000,Max=2.800000)
     End Object
     Emitters(7)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter5'
     ...
     End Object
     Emitters(8)=SpriteEmitter'Doom3KF_BossDemonSpawn.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'Doom3KF_BossDemonSpawn.MeshEmitter0'
