class Doom3KF_VagaryClassicProj extends Doom3KF_DoomProjectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (EffectIsRelevant(Location, false))
		Spawn(class'Doom3KF_VagaryClassicProjExplosion');
	Destroy();
}
simulated function PostNetBeginPlay()
{
	...
	{
		Spawn(Class'Doom3KF_VagaryProjEmitter');
		bNetNotify = true;
	}
}
...
defaultproperties
{
     ...
     MyDamageType=Class'Doom3KF_DamTypeVagaryClassicProj'
